...
def main():
    ...
    try:
        ...
        print(f"   Supported: {report.supported_count} | Conflicted: {report.conflicted_count} | Insufficient: {report.insufficient_count}")
        
        print("\n✅ SUPPORTED CLAIMS:")
        supported_claims = [v for v in report.verdicts if v.verdict == VerdictEnum.SUPPORTED]
        ...
        for claim_id in report.risky_claim_ids:
            ...
            reason_detail = v.rationale.missing_evidence_reason or v.rationale.contradiction_type or v.rationale.text
